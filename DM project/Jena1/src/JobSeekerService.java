...
public class JobSeekerService {
		...
		public JobSeekerModel getRequiredInstanceVal(String id){
			...
			OntProperty yearprop=smodel.getOntProperty(ns+"hasDate_of_Birth");
			...
			String year=m.getPropertyValue(yearprop).asLiteral().toString();
			
			return new JobSeekerModel(wrkexp, plcation, cmp, year);
